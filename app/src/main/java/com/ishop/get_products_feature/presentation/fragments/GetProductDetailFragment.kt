 ...
 * Use the [GetProductDetailFragment.newInstance] factory method to
...
class GetProductDetailFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment GetProductDetailFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            GetProductDetailFragment().apply {
